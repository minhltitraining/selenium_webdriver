...
public class WebOrder_DeleteOrder_VerifyOrder {
	...
	public void delete_order() throws InterruptedException {
		driver.findElement(By.xpath("//td[text()='" + expUsername +"']//preceding-sibling::td/input")).click();
		driver.findElement(By.name("ctl00$MainContent$btnDelete")).click();
		Boolean deletedUsername = driver.getPageSource().contains(expUsername);
		Assert.assertFalse(deletedUsername);
	}
